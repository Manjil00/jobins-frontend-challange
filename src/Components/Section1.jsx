...
{/* Profit */}
<div className="Profit w-[398px] h-[180px]  md:h-auto md:w-auto bg-white rounded-xl mt-3 flex ml-2 md:ml-4 p-3">
...
{/* //CountryWiseSales */}
<div className="CountrywiseSales md:w-[450px] h-auto flex flex-col mt-3 md:ml-4 bg-white rounded-xl p-3">
{/* US */}

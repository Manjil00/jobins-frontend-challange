...
const Sidebar = () => {
return (
<div className="sidebar h-full w-[35%] md:w-[15%] bg-white ">
...
<h2 className='text-slate-500 font-mainfont font-normal ml-3 text-xs md:text-lg'>MAIN MENU</h2>

    <div className='Dash-Router flex mt-3'>
    <img src="../icons/smart-home.png" className="h-[20px] w-[20px] ml-3 md:mx-3" alt="Logo"/>
    <h1 className='text-slate-500 font-mainfont font-normal  cursor-pointer text-xs md:text-lg hover:text-black hover:font-bold'>Dashboard</h1>
    </div>
    ...
    <h1 className='text-slate-500 font-mainfont font-normal cursor-pointer text-xs md:text-lg hover:text-black hover:font-bold'>Order <br/>Management</h1>
    </div>

    <div className='Brand-Router flex mt-3'>
    <img src="../icons/star.png" className="h-[20px] w-[20px] ml-3 md:mx-3" alt="Logo"/>
    <h1 className='text-slate-500 font-mainfont font-normal cursor-pointer text-xs md:text-lg hover:text-black hover:font-bold'>Brand</h1>
    </div>

</div>

<div className="PRODUCTS mt-10 bg-white h-auto w-full flex flex-col justify-start">
<h2 className='text-slate-500 font-mainfont font-normal text-xs md:text-lg ml-3 md:mx-3'>PRODUCTS </h2>

    <div className='ADD-Router flex mt-3'>
    <img src="../icons/circle-plus.png" className="h-[20px] w-[20px] ml-3 md:mx-3" alt="Logo"/>
    <h1 className='text-slate-500 font-mainfont font-normal cursor-pointer text-xs md:text-lg hover:text-black hover:font-bold'>Add Products</h1>
    </div>

    <div className='LIST-Router flex mt-3'>
    <img src="../icons/box.png" className="h-[20px] w-[20px] ml-3 md:mx-3" alt="Logo"/>
    <h1 className='text-slate-500 font-mainfont font-normal cursor-pointer text-xs md:text-lg hover:text-black hover:font-bold'>Product List</h1>
    </div>
